...
namespace MSCDA5510
{
    class ContactGenerator
    {
        ...
        {
            String COMMA = ",";
            String outputFileName = @"C:\Users\jasle\Documents\GitHub\A00425843_MCDA5510\ConsoleApp1\ConsoleApp1\customers.csv";
        ...
        {
            String firstNames = @"C:\Users\jasle\Documents\GitHub\A00425843_MCDA5510\ConsoleApp1\ConsoleApp1\firstNames.txt";
            return ReturnRandomLine(firstNames);
        }

        public string GenerateLastName()
        {
            String lastNames = @"C:\Users\jasle\Documents\GitHub\A00425843_MCDA5510\ConsoleApp1\ConsoleApp1\lastNames.txt";
            return ReturnRandomLine(lastNames);
        }
        public string GenerateStreetNumber()
        {
            String StreetNumber = @"C:\Users\jasle\Documents\GitHub\A00425843_MCDA5510\ConsoleApp1\ConsoleApp1\StreetNumber.txt";
            return ReturnRandomLine(StreetNumber);
        }
        public string GenerateEmail()
        {
            String Email = @"C:\Users\jasle\Documents\GitHub\A00425843_MCDA5510\ConsoleApp1\ConsoleApp1\Email.txt";
            return ReturnRandomLine(Email);
        }
